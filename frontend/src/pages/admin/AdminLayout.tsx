...
const pageTitles: Record<string, string> = {
  ...
  '/admin/stock':              'สต๊อกอะไหล่',
  '/admin/pending-jobs':       'งานค้าง',
  '/admin/purchase-requests':  'คำขอสั่งซื้ออะไหล่',
}

export default function AdminLayout() {
  const location = useLocation()
  const title = Object.entries(pageTitles).find(([path]) => location.pathname.startsWith(path))?.[1] ?? 'ผู้ดูแลระบบ'

...
export default function PurchaseOrdersPage() {
  ...
  const [newSupplier, setNewSupplier] = useState({ companyName: '', contactName: '', phone: '', email: '', address: '' })
  ...
  const handleAddSupplier = () => {
    ...
    setNewSupplier({ companyName: '', contactName: '', phone: '', email: '', address: '' })
    setSupplierSaved(true)
    setTimeout(() => { setSupplierSaved(false); setShowAddSupplier(false) }, 1200)
  }
  ...
  return (
    <div className="p-6 bg-[#F5F5F5] min-h-full flex flex-col">
        ...
        <div className="flex w-full items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 rounded-xl border border-gray-300 bg-white text-gray-700 text-sm font-medium hover:bg-gray-50 hover:border-gray-400 transition-colors"
            >
      ...
      {/* Add Supplier Modal */}
      {showAddSupplier && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4" onClick={() => setShowAddSupplier(false)}>
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg flex flex-col overflow-hidden animate-in zoom-in-95" onClick={e => e.stopPropagation()}>
            <div className="px-6 pt-5 pb-4 border-b border-gray-100 flex items-center justify-between">
              <div>
                <p className="text-xs font-semibold text-[#F8981D] uppercase tracking-widest mb-0.5">RevUp</p>
                <h2 className="text-base font-semibold text-[#1E1E1E]">เพิ่ม Supplier ใหม่</h2>
              </div>
              <button onClick={() => setShowAddSupplier(false)} className="text-gray-400 hover:text-gray-600 bg-transparent border-none cursor-pointer text-xl leading-none">✕</button>
            </div>
            ...
            {supplierSaved ? (
              <div className="px-6 py-10 flex flex-col items-center gap-3">
                ...
                <p className="text-sm font-semibold text-gray-700">เพิ่ม Supplier สำเร็จ</p>
              </div>
            ) : (
              <>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="col-span-2">
                      ...
                      <input
                        ...
                        onChange={e => setNewSupplier(p => ({ ...p, companyName: e.target.value }))}
                        placeholder="เช่น BNS Parts Co., Ltd."
                ...
                <div className="flex border-t border-gray-100">
                  ...
                  <button
                    ...
                    disabled={!newSupplier.companyName.trim()}

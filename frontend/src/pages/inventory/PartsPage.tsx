              ...
              <div className="flex items-center gap-1.5 px-3">
                {Array.from({ length: totalPages }).map((_, i) => (
                  <button
                    ...
                    className={`min-w-[32px] h-[32px] flex items-center justify-center rounded-full text-sm font-medium transition-colors ${i + 1 === currentPage ? 'bg-[#F8981D] text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100'}`}
                  >
                    {i + 1}
                  </button>
                ))}
